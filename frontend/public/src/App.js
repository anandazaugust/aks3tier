...
const App = () => {
  ...
  const handleAddUser = async (e) => {
    ...
    try {
      ...
      // Call fetchUsers again to reload the users list
      fetchUsers();
    } catch (error) {
  ...
  // Ensure that fetchUsers is called when the component mounts
  useEffect(() => {
    fetchUsers();  // This ensures the user list is loaded when the component is mounted
  }, []);
